...
**M2.10「読める・戻せる」は未到達**（Phase 2.10 が残る）。

**Phase 2.9 は 2026-09-04 に完了した。DoD 2項目を実機で確認済み。**
2.9-2（親子の反転、`Ctrl+Shift+↑`）と 2.9-3（アウトラインの掴み替え）を入れた。
**M2.10「読める・戻せる」の残りは Phase 2.10 のみ。**
